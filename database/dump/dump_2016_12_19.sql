...
--
-- Host: localhost:3306
-- Generation Time: Dec 19, 2016 at 01:13 AM
...
(1.0, '/api/create/init'),
(2.0, '/api/create/filter'),
(2.1, '/api/create/content'),
(2.2, '/api/create/partial'),
(3.0, '/api/create/settings'),
(4.0, '/api/create/review'),
(5.0, '/api/checkout');
...
(1, 2, 'beatboxfamily.it/', '', 'events', '', '8LKvfO2WbmUAbmrX8ibfETbeVmv4v9yG', 'PAY-XXXXXXXXXXXXXXXXXXXXXXXX', 0, 0, 'italianbeatboxfamily', 'full', '2016-07-17 19:03:47', '2016-12-18 19:25:37'),
(2, 2, 'farmaciaamazzone.it', '', 'posts', '', 'N9jxmLlUmxPB0L3D0jPbAbrIjUwqgxHU', 'PAY-XXXXXXXXXXXXXXXXXXXXXXXX', 0, 0, 'farmacia.amazzone', 'full', '2016-08-24 15:32:01', '2016-12-18 19:25:37'),
(3, 2, 'ideoplayground.com', '', 'posts', '', 'Zp4ez8hi3BmSQ4GC7HkmyZ7ZCwDaahzo', 'PAY-XXXXXXXXXXXXXXXXXXXXXXXX', 0, 0, 'allaredenzionetrieste', 'full', '2016-09-02 16:31:31', '2016-12-18 19:25:37'),
(4, 2, 'ideoplayground.com', '', 'posts', '', '5LHXuzdoxIrnGIb9XTX54qRGl2upNVV9', 'PAY-XXXXXXXXXXXXXXXXXXXXXXXX', 0, 0, 'sportebenstare', 'full', '2016-12-06 09:23:58', '2016-12-18 19:25:37');
...
(1, 'admin', 'cris94and1@gmail.com', '$2y$10$OtJdioaBDpm5VaZa2bNCruXp.912J2hmtVib1KM.SySK/4EPbIMhy', 'admin', NULL, '2015-12-19 20:55:10', '2015-12-19 20:55:10'),
(2, 'ìdeo', 'info@ideonetwork.it', '$2y$10$GZkaT3I6rYp0fdx02wVjXO6ZWatjOcrxs3cr0ZFxI3G508dku/sFa', 'moderator', NULL, '2015-12-19 20:55:10', '2015-12-19 20:55:10'),
(3, 'Davide Saggioro', 'saggiorodavide@gmail.com', '$2y$10$fmnsRzSDcvl/aK85xlT6HeMS7P3C38jfdG0zDY/A5ZC1pHAghuyqO', 'member', NULL, '2016-08-07 15:37:10', '2016-12-18 19:25:37');
...
--
ALTER TABLE `fb_api_group_partial_mode`
  MODIFY `id_api_group` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
